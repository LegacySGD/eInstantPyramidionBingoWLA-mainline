...
public class CashPyramidWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(CashPyramidWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CashPyramidWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CashPyramidWLAIW/InitOutcome.xml").getDocumentElement();
